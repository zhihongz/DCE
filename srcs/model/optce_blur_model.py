...
class CEBlurNet(nn.Module):
    ...
    def __init__(self, sigma_range=0, test_sigma_range=0, ce_code_n=32, frame_n=64, ce_code_init=None, opt_cecode=False, binary_fc=None):
    ...
    def forward(self, frames):
        ...
        ce_code_up = torch.matmul(
            self.upsample_matrix.to(ce_code.device), ce_code)
